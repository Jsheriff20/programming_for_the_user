<?php
	...
	if(!mysqli_stmt_prepare($stmt, $sql)){
        ...
        if($bookingService == "Disability Support"){
            $ServiceTable = "BookingForDisabilitySupport";
        }
        else if($bookingService == "Financial Advisory"){
            $ServiceTable = "BookingForFinancialAdvisory";
        }
        else if($bookingService == "Learning Support"){
            $ServiceTable = "BookingForLearningSupport";
        }
        else if($bookingService == "Mental Health Support"){
            $ServiceTable = "BookingForMentalHealthAndWelfareSupport";
        }
        else if($bookingService == "Student Advisory"){
