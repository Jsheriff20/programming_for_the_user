	...
	<!--show infomation for 1stbooking on account-->
		...
		<p>You must delete a current booking to make another</p>
			<table class="table table-sm table-dark">
				...
				<form name="deleteBookingForm" id="deleteBookingForm" method="post" action="deleteBooking.php" onsubmit="return confirm_delete_booking()">
					<button id="Booking1" name="Booking1" class="btn btn-primary btn-md shadow-none" > Delete Booking! </button>
					<label id="confirm_deletion_booking1" class="confirm_deletion" for="Booking1">Click Again To Confirm Deletion! </label>
				</form>	
			</table>
			...
			<table class="table table-sm table-dark">
				...
				<form name="deleteBookingForm" id="deleteBookingForm" method="post" action="deleteBooking.php" onsubmit="return confirm_delete_booking()">
					<button id="Booking1" name="Booking2" class="btn btn-primary btn-md shadow-none" > Delete Booking! </button>
					<label id="confirm_deletion_booking2" class="confirm_deletion" for="Booking2">Click Again To Confirm Deletion! </label>
				</form>	
