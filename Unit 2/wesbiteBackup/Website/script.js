...
function validateForm() {
	...
	const Step1 = new Audio('../../Audio/BookingStep1.mp3');
	const Step2 = new Audio('../../Audio/BookingStep2.mp3');
	const Step3 = new Audio('../../Audio/BookingStep3.mp3');
	const Step4 = new Audio('../../Audio/BookingStep4.mp3');
	const Step5 = new Audio('../../Audio/BookingStep5.mp3');
	const Step6 = new Audio('../../Audio/BookingStep6.mp3');

	function BookingAudioFunction(audio) {

		switch(audio){
			case "BookingStep1":
					Step1.play();
					pauseStatus = "BookingStep1";
					break;
			
				case "BookingStep2":
					Step2.play();
					pauseStatus = "BookingStep2";
					break;
				...
				case "BookingStep3":
					Step3.play();
					pauseStatus = "BookingStep3";
					break;


				case "BookingStep4":
					Step4.play();
					pauseStatus = "BookingStep4";
					break;


				case "BookingStep5":
					Step5.play();
					pauseStatus = "BookingStep5";
					break;


				case "BookingStep6":
					Step6.play();
					pauseStatus = "BookingStep6";
					break;
		}
	}
